 ...
 * 
 */
package es.caib.pluginsib.arxiu.filesystem;
...
public class LuceneHelper {
	...
	public String documentCrear(
			es.caib.pluginsib.arxiu.api.Document document,
			String uuid,
			String pareUuid,
			String identificadorEni,
			String path) throws IOException {
	...
	public void documentModificar(
			es.caib.pluginsib.arxiu.api.Document document) throws IOException {
		Document docGuardat = findByUuid(
	...
	public es.caib.pluginsib.arxiu.api.Document documentDetalls(
			String uuid) throws IOException, ParseException {
		Document doc = findByUuid(
				ContingutTipus.DOCUMENT,
				uuid);
