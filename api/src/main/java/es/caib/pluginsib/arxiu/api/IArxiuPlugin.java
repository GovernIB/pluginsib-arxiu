...
/**
 * Interfície del plugin per a accedir a la funcionalitat d'un arxiu digital.
 *
 * @author Limit Tecnologies <limit@limit.es>
 */
public interface IArxiuPlugin extends IPluginIB {

    public static final String ARXIU_BASE_PROPERTY =  IPluginIB.IPLUGINSIB_BASE_PROPERTIES + "arxiu.";
     ...
     *            Identificador de l'expedient.
     * @param versio
     *            Versió de l'expedient (opcional). Si te el valor null es consulta la darrera
     *            versió disponible.
     * @return La informació de l'expedient.
     * @throws ArxiuException
     *             Si es produeix algun problema al realitzar l’operació amb l’arxiu.
     */
    public Expedient expedientDetalls(String identificador, String versio)
            throws ArxiuException;
     ...
     * @param pagina
     *            Número de la pàgina de resultats que s'ha de retornar. Si te el valor null es
     *            fa la consulta sense paginació.
     * @param itemsPerPagina
     *            Nombre d'elements per pàgina. Si te el valor null es fa la consulta sense
     *            paginació.
     ...
     *             Si es produeix algun problema al realitzar l’operació amb l’arxiu.
     */
    public ContingutArxiu expedientCrearSubExpedient(Expedient expedient,
     ...
     *             Si es produeix algun problema al realitzar l’operació amb l’arxiu.
     */
    public String expedientLligar(String identificadorPare, String identificadorFill)
            throws ArxiuException;
     ...
     *             Si es produeix algun problema al realitzar l’operació amb l’arxiu.
     */
    public void expedientDeslligar(String identificadorPare, String identificadorLligam)
            throws ArxiuException;
     ...
     *            Identificador de l'expedient pare del document. Si coincideix amb el valor de
     *            identificadorPare es pot deixar en blanc.
     * @return La informació sobre el document creat.
     * @throws ArxiuException
     *             Si es produeix algun problema al realitzar l’operació amb l’arxiu.
     */
    public ContingutArxiu documentCrear(Document document, String identificadorPare)
            throws ArxiuException;
     ...
     *             Si es produeix algun problema al realitzar l’operació amb l’arxiu.
     */
    public Document documentDetalls(String identificador, String versio, boolean ambContingut)
            throws ArxiuException;
     ...
     * @param repositori
     *            Repositori a on consultar els documents. Si no s'especifica (valor null)
     *            s'agafarà com a repositori eni:documento.
     * @return El resultat de la consulta.
     * @throws ArxiuException
     *             Si es produeix algun problema al realitzar l’operació amb l’arxiu.
     */
    public ConsultaResultat documentConsulta(List<ConsultaFiltre> filtres, Integer pagina,
            Integer itemsPerPagina, final DocumentRepositori repositori) throws ArxiuException;
     ...
     *             Si es produeix algun problema al realitzar l’operació amb l’arxiu.
     */
    public ContingutArxiu documentCopiar(String identificador, String identificadorDesti)
            throws ArxiuException;
     ...
     * @param identificadorDesti
     *            Identificador de la carpeta o expedient destí.
     * @return La informació sobre el document creat si aquest s'ha mogut entre diferents
     *         sèries documentals. Null en cas contrari.
     * @throws ArxiuException
     *             Si es produeix algun problema al realitzar l’operació amb l’arxiu.
     */
    public ContingutArxiu documentMoure(String identificador, String identificadorDesti)
            throws ArxiuException;
     ...
     *            Identificador de l'expedient destí del document. Si coincideix amb el valor
     *            de identificadorDesti es pot deixar en blanc.
     * @return La informació sobre el document creat si aquest s'ha mogut entre diferents
     *         sèries documentals. Null en cas contrari.
     * @throws ArxiuException
     *             Si es produeix algun problema al realitzar l’operació amb l’arxiu.
     ...
     *             Si es produeix algun problema al realitzar l’operació amb l’arxiu.
     */
    public ContingutArxiu carpetaCrear(Carpeta carpeta, String identificadorPare)
            throws ArxiuException;
     ...
     *             Si es produeix algun problema al realitzar l’operació amb l’arxiu.
     */
    public ContingutArxiu carpetaCopiar(String identificador, String identificadorDesti)
            throws ArxiuException;
     ...
     *             Si es produeix algun problema al realitzar l’operació amb l’arxiu.
     */
    public void carpetaMoure(String identificador, String identificadorDesti)
            throws ArxiuException;
    ...
    /**
     * Indica si la implementació del plugin suporta el versionat de expedients.
     * 
    ...
    /**
     * Indica si la implementació del plugin suporta el versionat de documents.
     * 
     * @return true si ho suporta o false en cas contrari.
     */
    ...
    /**
     * Indica si la implementació del plugin suporta el versionat de carpetes.
     * 
     * @return true si ho suporta o false en cas contrari.
     */
    ...
    /**
     * Indica si la implementació del plugin suporta le gestió de les metadades NTI.
     * 
     * @return true si ho suporta o false en cas contrari.
     */
    ...
    /**
     * Indica si la implementació del plugin genera automàticament l'identificador NTI dels
     * expedients i documents.
     * 
     ...
     * Retorna la URL de la versió original del document.
     *
     * @param doc Instància de ContingutArxiu
     * @return La URL de la versió original del document.
     * @throws ArxiuException
     *             Si es produeix algun problema al realitzar l’operació amb l’arxiu.
     */
