...
public abstract class AbstractArxiuPlugin extends AbstractPluginProperties implements IArxiuPlugin {
    ...
    public String getOriginalFileUrl(String identificadorDoc) throws ArxiuException {
        ...
        String csvValidationUrlEL = getProperty(getPropertyBase() + ABSTRACT_ORIGINAL_FILE_URL_EXPRESSION_LANGUAGE);
    ...
    public String getPrintableFileUrl(String identificadorDoc) throws ArxiuException {
        ...
        String csvValidationUrlEL = getProperty(getPropertyBase() + ABSTRACT_PRINTABLE_FILE_URL_EXPRESSION_LANGUAGE);
    ...
    public String getEniFileUrl(String identificadorDoc) throws ArxiuException {
        ...
        String csvValidationUrlEL = getProperty(getPropertyBase() + ABSTRACT_ENI_FILE_URL_EXPRESSION_LANGUAGE);
    ...
    public String getValidationFileUrl(String identificadorDoc) throws ArxiuException {
        String validationFileUrlEL = getProperty(getPropertyBase() + ABSTRACT_VALIDATION_FILE_URL_EXPRESSION_LANGUAGE);
    ...
    public static String processExpressionLanguage(String plantilla, Map<String, Object> custodyParameters,
            Locale locale) throws ArxiuException {
        try {
            if (plantilla == null) {
                return null;
            }
