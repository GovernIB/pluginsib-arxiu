...
public interface IArxiuPlugin extends IPlugin {
   ...
   * @param pagina
   *          Número de la pàgina de resultats que s'ha de retornar. Si te el valor null es fa
   ...
   *           Si es produeix algun problema al realitzar l’operació amb l’arxiu.
   */
  public void expedientTancar(String identificador) throws ArxiuException;
   ...
   *           Si es produeix algun problema al realitzar l’operació amb l’arxiu.
   */
  public void documentMoure(String identificador, String identificadorDesti)
      throws ArxiuException;
